...
const getAllOrders = async () => {
  return db.query(
    'SELECT o.order_id, u.id as user_id, u.firstname, u.lastname, u.email,  e.date, e.id as event_id, o.event_quantity, e.title, e.price  FROM `order` as o JOIN user AS u ON o.user_id = u.id JOIN event as e ON o.event_id = e.id'
  );
};
